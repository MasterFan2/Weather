package com.masterfan.weather.widget.mdialog;
...
public class MasterDialog extends Dialog {
	...
	public MasterDialog(Context context, int theme) {
        super(context, theme);
    }
    ...
    public static class Builder {
        ...
        //---------------------------------------------------------
        public MasterDialog create() {
        	//
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            
            // instantiate the dialog with the custom Theme
            final MasterDialog dialog = new MasterDialog(context, R.style.Dialog);
